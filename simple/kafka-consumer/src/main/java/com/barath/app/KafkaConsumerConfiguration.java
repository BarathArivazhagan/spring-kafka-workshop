...
public class KafkaConsumerConfiguration {
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<Long, Order> orderReplyContainerFactory() {
	...
	@Bean
	public ProducerFactory<Long, Order> orderReplyProducerFactory() {
		...
		return new DefaultKafkaProducerFactory<Long, Order>(props);
	}

	@Bean
	public KafkaTemplate<Long, Order> orderReplyTemplate() {
